 ...
 */
open class MenuContainerViewController: UIViewController,UIGestureRecognizerDelegate {
    ...
    override open func viewDidLoad() {
        ...
        //    my change
        screenEdgePanRecognizer.delegate = self as! UIGestureRecognizerDelegate
    }
